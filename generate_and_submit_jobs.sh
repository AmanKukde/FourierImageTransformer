...
commands=(
    ...
    # "srun python3 /home/aman.kukde/Projects/arch/FourierImageTransformer/main.py --job_id \$SLURM_JOB_ID --num_nodes \$SLURM_JOB_NUM_NODES --dataset CelebA --loss sum --model_type mamba --w_phi 1000 --batch_size 16 --d_query 32 --n_layers 8 --n_heads 8 --no_of_sectors 10"
    ...
    # "srun python3 /home/aman.kukde/Projects/arch/FourierImageTransformer/main.py --job_id \$SLURM_JOB_ID --num_nodes \$SLURM_JOB_NUM_NODES --dataset CelebA --loss sum --model_type mamba --w_phi 1000 --batch_size 16 --d_query 64 --n_layers 8 --n_heads 8 --no_of_sectors 10"
    "srun python3 /home/aman.kukde/Projects/arch/FourierImageTransformer/main.py --job_id \$SLURM_JOB_ID --num_nodes \$SLURM_JOB_NUM_NODES --dataset MNIST --loss sum --model_type mamba --w_phi 1000 --batch_size 32 --d_query 128 --n_layers 12 --n_heads 12 --no_of_sectors 10 --note 'linearinterpolationboth'"
    # "srun python3 /home/aman.kukde/Projects/arch/FourierImageTransformer/main.py --job_id \$SLURM_JOB_ID --num_nodes \$SLURM_JOB_NUM_NODES --dataset CelebA --loss sum --model_type mamba --w_phi 1000 --batch_size 16 --d_query 128 --n_layers 12 --n_heads 12 --no_of_sectors 10"
